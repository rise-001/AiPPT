...
import { Home, Key, Image, Zap, Save, RotateCcw, Globe, FileText, Brain, ArrowUp, Link2, ChevronDown, Volume2, Info, RefreshCw, CheckCircle } from 'lucide-react';
...
export const Settings: React.FC = () => {
  ...
  const handleServiceTest = async (
    ...
    try {
      ...
      // Sensitive fields are only sent when filled. Base/source fields are sent
      // even when empty so an unsaved clear is honored during service tests.
